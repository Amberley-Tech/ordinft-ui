...
export default function Pending({ setOpen, orderDetails, invoice }) {
      ...
      <div className="modal-body p-6">
        ...
        <div className="dark:border-jacarta-600 border-jacarta-100 relative flex items-center border-t border-b py-4">
          ...
          <div className="ml-auto">
            <div className="w-80 relative">
              <span className="block w-full dark:bg-jacarta-700 dark:border-jacarta-600 focus:ring-accent border-jacarta-100 rounded-full border py-3 px-4 dark:text-white dark:placeholder-white">
                {invoice.pay_address.slice(0, 8)}....
                {invoice.pay_address.slice(-8)}{" "}
              </span>
              <button
                type="button"
        ...
        <div className="mt-4 flex flex-col justify-center gap-2">
          <span className="normal-case dark:text-jacarta-200 text-sm">
            Please make the payment to the above address.
          </span>
          <span className="normal-case dark:text-jacarta-200 text-sm">
