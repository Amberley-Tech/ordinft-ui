...
const BlochainDropdown = ({ data }) => {
  const [setInscriptionNetwork] = useInscribeStore((state) => [
    state.setInscriptionNetwork,
  ]);
  ...
  const handleItemClick = (item) => {
    setActiveItem(item);
    setInscriptionNetwork(item.value);
    setDropdown(false);
  };
...
export default BlochainDropdown;
