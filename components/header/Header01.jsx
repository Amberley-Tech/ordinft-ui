      ...
      <header className="js-page-header fixed top-0 z-20 w-full backdrop-blur transition-colors">
        <div className="flex items-center px-6 py-6 xl:px-24 ">
          <Link className="shrink-0" href="/">
            <a>
              <div className="flex justify-center gap-3 items-center dark:hidden">
                <Image
                  src={WhiteLogo}
                  height={54}
                  width={54}
                ...
                />
                <p className="font-display text-md md:text-lg lg:text-xl tracking-wide">
                  OrdiNFT
                </p>
              </div>
              <div className="justify-center gap-3 items-center hidden dark:flex">
                <Image src={Logo} height={54} width={54} />
                <p className="font-display text-md md:text-lg lg:text-xl tracking-wide">
                  OrdiNFT
                </p>
              </div>
                  ...
                  <Link href="/orders">
                    <a>
                      <button className="text-jacarta-700 font-display hover:text-accent focus:text-accent dark:hover:text-accent dark:focus:text-accent flex items-center justify-between py-3.5 text-base dark:text-white lg:px-5">
                        <span
                          className={
                            isChildrenPageActive(route.asPath, "/orders")
                              ? "text-accent dark:text-accent"
                              : ""
                          }
                        >
                  ...
                  <Link href="/inscribe">
                    <a>
                      <button className="text-jacarta-700 font-display hover:text-accent focus:text-accent dark:hover:text-accent dark:focus:text-accent flex items-center justify-between py-3.5 text-base dark:text-white lg:px-5">
                        <span
                          className={
                            isChildrenPageActive(route.asPath, "/inscribe")
                              ? "text-accent dark:text-accent"
                              : ""
                          }
                        >
              ...
              <Link href="/orders">
                <a>
                  <button className="text-jacarta-700 font-display hover:text-accent focus:text-accent dark:hover:text-accent dark:focus:text-accent flex items-center justify-between py-3.5 text-base dark:text-white lg:px-5">
                    <span
                      className={
                        isChildrenPageActive("/orders", route.asPath)
                          ? "text-accent dark:text-accent"
                          : ""
                      }
                    >
              ...
              <Link href="/inscribe">
                <a>
                  <button className="text-jacarta-700 font-display hover:text-accent focus:text-accent dark:hover:text-accent dark:focus:text-accent flex items-center justify-between py-3.5 text-base dark:text-white lg:px-5">
                    <span
                      className={
                        isChildrenPageActive("/inscribe", route.asPath)
                          ? "text-accent dark:text-accent"
                          : ""
                      }
                    >
